...
@section('content')
    <div class="container">
        <div class="row" id="header">
            <h3>Hi, Enzo - Welcome to UneFois!</h3>
        ...
        <div class="row" id="steps">
            ...
            <div class="four columns">
                ...
                <div class="row">
                    <h6>Setup UneFois</h6>
                    <p>Learn how to use UneFois with your business</p>
                </div>
                <div class="row">
            ...
            <div class="four columns">
                ...
                <div class="row">
                    ...
                    <p>See what you can do with UneFois</p>
                </div>
                <div class="row">
                    <button>Start</button>
                </div>
        ...
        <div class="row" id="developers">
            ...
            <div class="ten columns">
                <div class="six columns">
                    <h6>API Docs</h6>
                    <p>Our documentation contains the Libraries, APIs, and SDKs you need to integrate UneFois in your website or app.</p>
